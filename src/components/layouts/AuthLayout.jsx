...
const AuthLayout = ({ children }) => {
  ...
  return (
    <div className={`flex flex-col md:flex-row h-screen w-screen overflow-hidden transition-opacity duration-700 ${showPage ? "opacity-100" : "opacity-0"}`}>
      {/* Left Side  */}
      <div className="hidden md:flex flex-1 items-center justify-center pl-20">
        <img src={loginIllustration} alt="Login Illustration" className="hidden md:block w-[420px] h-auto object-contain" />
      </div>
        ...
        <div className="w-full max-w-md h-full flex flex-col items-center justify-center space-y-4">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold leading-snug">
              Selamat Datang   <br />
              <span className="text-black">di Stakeholder Management System</span>
            </h2>
          ...
          <div className="md:hidden flex justify-center">
            <img src={loginIllustration} alt="Login Illustration" className="w-48 h-auto object-contain" />
          </div>
