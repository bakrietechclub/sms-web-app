                ...
                contacts.map((item, index) => (
                  ...
                  >
                    ...
                    <td className='px-4 py-3 text-center'>
                      <Label
                        label={
                          item?.contactStatusJoined
                            ? 'Join Grup'
                            : 'Belum Join Grup'
                        }
                        status={
                          item?.contactStatusJoined ? 'success' : 'danger'
                        }
                      />
                    </td>
                    <td className='px-4 py-3 text-center'>
                      <Label
                        label={
                          item?.contactStatusActive ? 'Aktif' : 'Tidak Aktif'
                        }
                        status={
                          item?.contactStatusActive ? 'success' : 'danger'
                        }
                      />
                    </td>
                    <td className='px-4 py-3 text-center'>
