    ...
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='mb-4'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <Button className={updateButtonClasses}>Perbarui</Button>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
        ...
        <div className='bg-white rounded-xl p-5 shadow-sm'>
          ...
          <dl className='space-y-3 text-sm'>
            ...
            <div className='flex items-start'>
              <dt className='text-xs font-medium text-gray-500 uppercase tracking-wide w-32'>
                Link Dokumen
              </dt>
              <dd className='flex-1'>
                {data?.MouDocumentUrl ? (
      ...
      <div className='bg-white rounded-xl p-5 mb-4 shadow-sm'>
        <h2 className='text-lg font-semibold text-gray-800 mb-4'>
          Detail Rencana Kolaborasi
        </h2>
        <div className='space-y-4'>
          <div>
            <p className='text-xs font-medium text-gray-500 uppercase tracking-wide mb-1'>
              Program LSD Rencana Kolaborasi
            </p>
            <p className='text-sm text-gray-900'>
              {data?.researchPrograms?.join(', ') || '-'}
            </p>
