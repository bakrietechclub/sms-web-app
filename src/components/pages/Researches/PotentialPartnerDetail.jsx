  ...
  if (loading) {
    return (
      <div className='max-w-7xl mx-auto animate-pulse'>
        ...
        {/* SWOT Analysis Card */}
        <div className='bg-white rounded-xl p-5 mb-4 shadow-sm'>
          <div className='h-6 w-38 bg-gray-200 rounded mb-4' />{' '}
          {/* Title: Analisis SWOT */}
  ...
  return (
    <>
      <div className='max-w-7xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-900'>
                {data?.partnershipResearchProgram?.join(', ') || '-'}
              </p>
            </div>
            ...
            <div>
              ...
              <Label
                ...
                status={
                  data?.contactStatus === 'Sudah dikontak'
                    ? 'success'
                    : 'danger'
                }
              />
        ...
        {/* Needs Section */}
        {data?.partnershipResearchNeeds &&
          data.partnershipResearchNeeds.length > 0 && (
            <div className='bg-white rounded-xl p-5 mb-4 shadow-sm'>
              <h2 className='text-lg font-semibold text-gray-800 mb-3'>
                Kebutuhan
              </h2>
              <p className='text-sm text-gray-900'>
                {data.partnershipResearchNeeds.join(', ')}
              </p>
            </div>
          )}
