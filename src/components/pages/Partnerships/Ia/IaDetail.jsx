...
} from '../../../../states/features/partnerships/ia/iaThunks';
import {
  selectIADetail,
  selectIALoading,
...
export default function IaDetail() {
  ...
  const canUpdate = hasAccess && can(PERM.PARTNERSHIPS_IA_UPDATE);
  const canDelete = hasAccess && can(PERM.PARTNERSHIPS_IA_DELETE);
    ...
    <div className='max-w-7xl mx-auto pb-10'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6'>
        ...
        <div className='flex gap-2'>
          ...
          <Button
            disabled={!canDelete}
            title={!canDelete ? 'Anda tidak memiliki izin untuk menghapus IA' : undefined}
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <InfoItem
                icon={Calendar}
                label='Tahun Implemenasi'
                value={data?.iaYearOfImplementations}
              />
              ...
              <div className='mb-4'>
                ...
                <Label
                  label={data?.iaPartnershipStatusName || 'Draft'}
                  status='success'
                />
              </div>
            </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <InfoItem
                ...
                value={data?.iaNameOfBcf}
              />
              <InfoItem
                label='Nama Pihak Mitra'
                value={data?.iaNameOfPartner}
              />
              <InfoItem
              ...
              <InfoItem
                ...
                value={data?.iaLetterNumberPartner}
              />
            </div>
          </div>
        </div>
