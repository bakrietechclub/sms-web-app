      ...
      <div className='max-w-7xl mx-auto pb-10 animate-pulse'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
          ...
          <div className='lg:col-span-2 space-y-6'>
            ...
            <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
              <div className='h-6 w-48 bg-gray-200 rounded mb-4' />
              <div className='h-32 bg-gray-200 rounded border border-gray-200' />{' '}
              {/* Table placeholder */}
            </div>
          </div>
    ...
    <div className='max-w-7xl mx-auto pb-10'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6'>
        <div>
          ...
          <h1 className='text-2xl font-bold text-gray-800'>Detail PKS</h1>
        </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <InfoItem
                ...
                value={data?.pksInstituteDivision}
              />
              <div className='mb-4'>
              ...
              <div className='col-span-full'>
                <InfoItem
                  ...
                  value={data?.pksDetailPartnership}
                />
              </div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <InfoItem
                ...
                value={data?.pksNameofBcf}
              />
              <InfoItem
                label='Nama Pihak Mitra'
                value={data?.pksNameOfPartner}
              />
              <InfoItem
                label='Nomor Surat BCF'
                value={data?.pksLetterNumberReference}
              />
              <InfoItem
                label='Nomor Surat Mitra'
                value={data?.pksPartnerLetterNumber}
              />
            </div>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='space-y-4'>
              <InfoItem
                ...
                value={data?.pksSignatureDate}
              />
              <InfoItem
                label='Jangka Waktu (Tahun)'
                value={data?.pksTimePeriod}
              />
              <InfoItem
                label='Tanggal Jatuh Tempo'
                value={data?.pksDueDate}
              />
            </div>
          </div>
