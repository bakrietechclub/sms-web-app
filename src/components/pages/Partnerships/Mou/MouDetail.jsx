    ...
    <div className='max-w-7xl mx-auto pb-10'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6'>
        <div>
          ...
          <h1 className='text-2xl font-bold text-gray-800'>Detail MoU</h1>
        </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div className='col-span-full'>
                <InfoItem
                  ...
                  value={data?.mouPartnershipDetail}
                />
              </div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <InfoItem
                ...
                value={data?.mouBcfName}
              />
              <InfoItem
                label='Nama Pihak Mitra'
                value={data?.mouPartnerName}
              />
              <InfoItem
                label='Nomor Surat BCF'
                value={data?.mouLetterNumberReference}
              />
              <InfoItem
                label='Nomor Surat Mitra'
                value={data?.mouPartnerLetterNumber}
              />
            </div>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='space-y-4'>
              <InfoItem
                ...
                value={data?.mouSignatureDate}
              />
              <InfoItem
                label='Jangka Waktu (Tahun)'
                value={
                  data?.mouTimePeriod ? `${data.mouTimePeriod} Tahun` : '-'
                }
              />
              <InfoItem
                label='Tanggal Jatuh Tempo'
                value={data?.mouDueDate}
              />
            </div>
          </div>
