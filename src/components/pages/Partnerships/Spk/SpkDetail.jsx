...
import {
  asyncGetSpkById,
  asyncDeleteSpkById,
} from '../../../../states/features/partnerships/spk/spkThunks';
...
export default function SpkDetail() {
  ...
  const canUpdate = hasAccess && can(PERM.PARTNERSHIPS_SPK_UPDATE);
  const canDelete = hasAccess && can(PERM.PARTNERSHIPS_SPK_DELETE);
    ...
    <div className='max-w-7xl mx-auto pb-10'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6'>
        ...
        <div className='flex gap-2'>
          ...
          <Button
            disabled={!canDelete}
            title={!canDelete ? 'Anda tidak memiliki izin untuk menghapus SPK' : undefined}
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <InfoItem
                ...
                value={data?.instituteTypeName}
              />
              <InfoItem
                label='Divisi Instansi'
                value={data?.institutionDivision}
              />
              ...
              <div className='mb-4'>
                ...
                <Label
                  label={data?.spkPartnershipStatus || 'Draft'}
                  status='success'
                />
              </div>
              ...
              <div className='col-span-full'>
                <InfoItem
                  ...
                  value={data?.spkDetailPartnership}
                />
              </div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <InfoItem
                ...
                value={data?.spkNameOfBcf}
              />
              <InfoItem
                label='Nama Pihak Mitra'
                value={data?.spkNameOfPartner}
              />
            </div>
          </div>
        </div>
          ...
          <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-100'>
            ...
            <div className='space-y-4'>
              <InfoItem
                ...
                value={data?.spkSignatureDate}
              />
              <InfoItem
                label='Jangka Waktu (Tahun)'
                value={
                  data?.spkTimePeriod ? `${data.spkTimePeriod} Tahun` : '-'
                }
              />
              <InfoItem
                label='Tanggal Jatuh Tempo'
                value={data?.spkDueDate}
              />
            </div>
          </div>
