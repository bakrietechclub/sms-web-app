...
export const AddModalSocialInstitution = ({ isOpen, onClose }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        >
          <div className="w-full h-[92px] px-6 flex items-center justify-between">
            <h2 className="text-2xl font-semibold">Form Tambah Mitra Lembaga/Universitas</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="px-6 pt-2 pb-4 space-y-4 overflow-y-auto" style={{ height: "calc(900px - 92px)" }} ref={dropdownRef}>
            ...
            <SingleSelectDropdown name="region" label="Region" options={allProvinces} register={register} setValue={setValue} />
            <ClusterSubClusterField register={register} setValue={setValue} clusterOptions={clusterOptions} subClusterOptions={subClusterOptions}/>
            <TextField name="peran" label="Peran" placeholder="Masukkan peran" register={register} />
            <TextField name="profil" label="Profil" placeholder="Masukkan profil" register={register} />
            <TextField name="wilayah jangkauan" label="Wilayah Jangkauan" placeholder="Masukkan wilayah jangkauan" register={register} />            
