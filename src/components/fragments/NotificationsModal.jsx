...
const sampleNotifications = [
  {
    ...
    type: "audiensis",
    title: "Audiensi",
    description: "anda dengan Universitas Indonesia akan dilaksanakan pada tanggal 05/11/2024.",
  ...
  },
  {
    ...
    type: "mou",
    title: "MoU",
    description: "dengan Politeknik Negeri Jakarta akan segera berakhir. Hubungi mitra untuk perbarui kerja sama.",
    date: "28 Oktober 2024",
    isRead: false,
  },
  {
    ...
    <>
      ...
      <div className="fixed top-0 right-0 h-screen w-110 bg-white z-50 shadow-xl rounded-l-xl">
        ...
        <div className="relative text-center py-2 border-b border-gray-100">
          ...
          <span className="bg-white px-3 text-sm text-gray-400">28 Oktober 2024</span>
        </div>
